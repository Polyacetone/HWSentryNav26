...
struct FollowerObstacleView {
    ...
    // 未融合、未掩膜的动态时间线：[当前帧, 未来预测帧...]。
    std::vector<CostMap::ConstPtr> dynamic_timeline;
