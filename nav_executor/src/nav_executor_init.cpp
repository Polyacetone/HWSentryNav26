    ...
    MPCParams mpc_params = {
        .follow = {
            ...
            .search = {
                ...
                .step_dir_dot_threshold = declare_parameter<double>("mpc.follow.search.step_dir_dot_threshold"),
                ...
                .w_progress = declare_parameter<double>("mpc.follow.search.weights.w_progress"),
                .w_brake = declare_parameter<double>("mpc.follow.search.weights.w_brake"),
                ...
                .w_step_vel = declare_parameter<double>("mpc.follow.search.weights.w_step_vel")
            },
