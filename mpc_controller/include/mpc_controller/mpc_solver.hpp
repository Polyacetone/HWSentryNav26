...
#include <string>
#include <Eigen/Dense>
#include <mpc_controller/fddp_solver.hpp>
...
namespace fddp {
template<>
struct Dims<mpc_controller::FollowProblem> {
    static constexpr int NX = mpc_controller::MPC_NX;
    static constexpr int NU = mpc_controller::MPC_NU;
    static constexpr int N = mpc_controller::MPC_HORIZON;
};
template<>
struct Dims<mpc_controller::StopProblem> {
    static constexpr int NX = mpc_controller::MPC_NX;
    static constexpr int NU = mpc_controller::MPC_NU;
    static constexpr int N = mpc_controller::MPC_HORIZON;
};
template<>
struct Dims<mpc_controller::RecoveryProblem> {
    static constexpr int NX = mpc_controller::MPC_NX;
    static constexpr int NU = mpc_controller::MPC_NU;
    static constexpr int N = mpc_controller::MPC_HORIZON;
};
template<>
struct Dims<mpc_controller::FixedProblem> {
    static constexpr int NX = mpc_controller::MPC_NX;
    static constexpr int NU = mpc_controller::MPC_NU;
    static constexpr int N = mpc_controller::MPC_HORIZON;
};
